...
//            subtitleLabel.bottomAnchor.constraint(equalTo: statusTextField.topAnchor, constant: -10),
            ...
            statusTextField.leadingAnchor.constraint(equalTo: subtitleLabel.leadingAnchor),
...
//            statusTextField.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -16),
            ...
            addButton.topAnchor.constraint(equalTo: statusTextField.bottomAnchor, constant: 33),
    ...
    @objc func buttonPressed() {
        if let statusText = statusTextField.text, !statusText.isEmpty {
            ...
            subtitleLabel.text = "Waiting for something..."
        }
    }
}
